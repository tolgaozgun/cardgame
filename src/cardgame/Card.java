 ...
 * Has methods for comparing current card against an another card
...
public class Card {
    ...
    /**
     * Initiate Card object with a integer of card number.
     * Each suit moves card's index by 13. Suits are ordered as following:
     * Hearts
     * Diamonds
     * Spades
     * Clubs
    ...
    /**
     * Returns the value of card without taking suits into consideration.
     * This returns an integer from 0 to 12.
    ...
    /**
     * Returns the suit value of card.
     * This returns an integer from 0 to 3.
     * Suits are ordered as following:
     * 0 - Hearts
     * 1 - Diamonds
     * 2 - Spades
     * 3 - Clubs
    ...
    /**
     * Returns the String value of the card. This String includes card's
     * suit and face value.
    ...
    /**
     * Compares a given card's face value with this card's face value.
     * Returns:
     * > 1 if this card's face value is bigger.
     * > 0 if both of the cards' face values are equal.
     * > -1 if other card has a bigger face value.
